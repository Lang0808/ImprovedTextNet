...
func GetRelationshipFromNumber(n int32) (*RelationshipType, error) {
	if _, ok := RelationshipType_name[n]; ok {
		ans := RelationshipType(n)
		return &ans, nil
	}
	return nil, errors.New("RelationshipType not found")
}
