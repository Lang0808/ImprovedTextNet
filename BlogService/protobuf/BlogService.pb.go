...
type GetUserBlogsWithRelationshipsRequest struct {
	...
	Offset       int32 `protobuf:"varint,2,opt,name=Offset,proto3" json:"Offset,omitempty"`
	Limit        int32 `protobuf:"varint,3,opt,name=Limit,proto3" json:"Limit,omitempty"`
	Relationship int32 `protobuf:"varint,4,opt,name=Relationship,proto3" json:"Relationship,omitempty"`
}
...
var file_BlogService_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x68, 0x69, 0x70, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52,
